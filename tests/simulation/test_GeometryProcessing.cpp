...
//     auto result = geometry_ptr->set_UV_border_edges(mesh_file_path, start_node);
...
//     auto results = geometry_ptr->get_cut_line(mesh, start_node, target_node, predecessor_pmap);
